...
<span class="badge-daviddm"><a href="https://david-dm.org/bevry/version-range" title="View the status of this project's dependencies on DavidDM"><img src="https://img.shields.io/david/bevry/version-range.svg" alt="Dependency Status" /></a></span>
<span class="badge-daviddmdev"><a href="https://david-dm.org/bevry/version-range#info=devDependencies" title="View the status of this project's development dependencies on DavidDM"><img src="https://img.shields.io/david/dev/bevry/version-range.svg" alt="Dev Dependency Status" /></a></span>
