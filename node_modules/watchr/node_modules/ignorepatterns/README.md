...
<span class="badge-githubworkflow"><a href="https://github.com/bevry/ignorepatterns/actions?query=workflow%3Abevry" title="View the status of this project's GitHub Workflow: bevry"><img src="https://github.com/bevry/ignorepatterns/workflows/bevry/badge.svg" alt="Status of the GitHub Workflow: bevry" /></a></span>
...
<li>Import: <code>import pkg from ('ignorepatterns')</code></li>
<li>Require: <code>const pkg = require('ignorepatterns').default</code></li>
</ul>
...
<ul><li><code>ignorepatterns/source/index.ts</code> is <a href="https://www.typescriptlang.org/" title="TypeScript is a typed superset of JavaScript that compiles to plain JavaScript. ">TypeScript</a> source code with <a href="https://babeljs.io/docs/learn-es2015/#modules" title="ECMAScript Modules">Import</a> for modules</li>
