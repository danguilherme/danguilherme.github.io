...
module.exports = {
  // Project
  invalidProject: `We couldn't find an existing DocPad project inside your current directory. Looked at: %s
...
For more information about what this means, visit:
  ...
  documentIdChangeError: `The document %s tried to overwrite its \`id\` attribute with its meta-data.
...
For more information, see: https://docpad.bevry.me/id-overwrite`,
  documentRenderExtensionNoChange: `Rendering the extension [%s] to [%s] on [%s] didn't do anything.
Explanation here: https://docpad.bevry.me/extension-not-rendering`,
  ...
  outPathConflict: `You have multiple files being written to [%s], they are:
  - %s
  - %s
  Rename one of them to avoid an overwrite`,
  renderedEarlyViaInclude: `Your include of %s has failed as that document has not been rendered yet.
For more information about what this means, visit:
