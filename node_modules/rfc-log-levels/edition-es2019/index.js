 ...
 */
function getLevelNumber(name, levels = exports.rfcLogLevels) {
    if (levels[name] == null) {
        return null;
    }
    else {
 ...
 */
function getLevelName(number, levels = exports.rfcLogLevels) {
 ...
 * ```
 */
function getLevelInfo(level, levels = exports.rfcLogLevels) {
